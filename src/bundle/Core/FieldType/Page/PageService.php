...
class PageService
{
    ...
    /** @var \MediataCom\MediataEzpageFieldtypeBundle\Core\FieldType\Page\PageStorage\Gateway */
     ...
     *
     * @return \MediataCom\MediataEzpageFieldtypeBundle\Core\FieldType\Page\PageStorage\Gateway
     */
     ...
     *
     * @throws \Ibexa\Core\Base\Exceptions\NotFoundException If block could not be found.
     *
     * @param int|string $id
     *
